...
import 'cupertino_datepicker_base.dart';

export 'package:intl/intl.dart' show DateFormat;



class CupertinoDateTimeFieldBlocBuilder extends StatelessWidget {
  const CupertinoDateTimeFieldBlocBuilder({
    Key key,
  ...
  Widget build(BuildContext context) {
    return CupertinoDateTimeFieldBlocBuilderBase<DateTime>(
      dateTimeFieldBloc: dateTimeFieldBloc,
      format: format,
      type: canSelectTime
          ? CupertinoDateTimeFieldBlocBuilderBaseType.both
          : CupertinoDateTimeFieldBlocBuilderBaseType.date,
