...
const Duration _kUnconfirmedSplashDuration = const Duration(milliseconds: 180);
const Duration _kSplashFadeDuration = const Duration(milliseconds: 700);

const double _kSplashInitialSize = 0.0; // logical pixels
const double _kSplashConfirmedVelocity = 0.4;

/*const Duration _kUnconfirmedSplashDuration = const Duration(milliseconds: 580);
const Duration _kSplashFadeDuration = const Duration(milliseconds: 400);

const double _kSplashInitialSize = 20.0; // logical pixels
